	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'cityvspoyo': //Week 1
				var bg:BGSprite = new BGSprite('poyo/bg', -700, -375, 1, 1);
				add(bg);
			case 'cityvspoyoold': //Week 1
				var bg:BGSprite = new BGSprite('poyo/OG_bg', -700, -375, 1, 1);
				add(bg);
			case 'too-slow': //Week 1
				var BG:BGSprite = new BGSprite('exe/BG', -1300, -700, 1, 1);
				var FG:BGSprite = new BGSprite('exe/BG', -1300, -700, 1, 1);
				var Fade:FlxSprite = new FlxSprite().loadGraphic(Paths.image('exe/RedVG'));
				
				Fade.scrollFactor.set();
				Fade.cameras = [camOther];
				Fade.alpha = 0;
